...
strategy_name = st.selectbox(
    "Select the strategy",
    ["52 week high strategy", "Gapup Strategy", "Mean Reversion Strategy"],
)
...
if st.button("Scan Stocks"):
    with st.spinner("abra-ca-dabra 🎩 ... "):
        ...
        if strategy_name == "52 week high strategy":
            ...
            st.write(
                "To understand the rules of the strategy, watch the complete course [here](https://learnapp.com/courses/price-action-strategy/topics/trailer)"
            )
            ...
            st.write(
                "To understand the rules of the strategy, watch the complete course [here](https://learnapp.com/courses/learn-intraday-strategy/topics/trailer)"
            )
